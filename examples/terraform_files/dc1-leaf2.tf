          ...
          group = [
            ...
            },
            {
              ...
              neighbor = [
                {
                  name = "10.30.136.1"
                  description = "EBGP peering to 10.30.136.1"
                  peer_as = 65501
                },
                {
                  name = "10.30.146.1"
                  description = "EBGP peering to 10.30.146.1"
                  peer_as = 65502
                }
              ]
            }
