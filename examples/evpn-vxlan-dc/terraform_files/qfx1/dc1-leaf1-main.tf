#Reading XML file: ../examples/evpn-vxlan-dc/dc1/dc1-leaf1.xml
...
resource "junos-vqfx_Apply_Groups" "dc1-leaf1" {
  resource_name = "JTAF_dc1-leaf1"
  provider = junos-vqfx.dc1-leaf1
  system = [
    {
      host_name = "dc1-leaf1"
      root_authentication = [
